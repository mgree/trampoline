...
var author$project$Trampoline$AndWait = {$: 'AndWait'};
...
var author$project$Simple$initializeEngineCmd = A2(
	elm$core$Task$perform,
	function (_n0) {
		return A2(
...
var author$project$Simple$main = elm$browser$Browser$element(
	{
		init: A2(
			author$project$Trampoline$init,
			function (_n0) {
				return _Utils_Tuple2(
					{
